...
### 项目首次运行
首次运行项目进行测试, 请先执行[User.sync()](http://docs.sequelizejs.com/manual/tutorial/models-definition.html#database-synchronization)将表结构同步到数据库.  
